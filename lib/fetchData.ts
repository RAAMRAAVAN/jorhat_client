...
export const HospitalName = 'JORHAT CANCER CENTRE';
export const HName = '/Jorhat';
...
export async function fetchDoctors2() {
  ...
  try {
    const response = await fetch(`https://barpetacancercentre.org/api/get-doctor-for-center`, {
      ...
      body: JSON.stringify({ ccode: "Jorhat" }),
      next: { revalidate: 900 },
      // cache: "no-store",
    });
...
export const FetchAboutUs = [
  {
    ...
    "HospitalID": 1,
    "title": "Who we are",
    "short_description": "Jorhat Cancer Centre – a unit of Assam Cancer Care Foundation (ACCF) - is located adjacent to Jorhat Medical College and Hospital (JMCH) at Jorhat. With its state-of-the-art infrastructure, the 44-bedded centre is equipped with advanced technology. The unit has a team of experienced Oncologists from reputed medical institutes and oncology-trained nurses to ensure best of treatment and care.",
    "read_more2": false,
    "description2": "Jorhat Cancer Centre – a unit of Assam Cancer Care Foundation (ACCF) - is located adjacent to Jorhat Medical College and Hospital (JMCH) at Jorhat. With its state-of-the-art infrastructure, the 44-bedded centre is equipped with advanced technology. The unit has a team of experienced Oncologists from reputed medical institutes and oncology-trained nurses to ensure best of treatment and care.",
    "description": "Jorhat Cancer Centre – a unit of Assam Cancer Care Foundation (ACCF) - is located adjacent to Jorhat Medical College and Hospital (JMCH) at Jorhat. With its state-of-the-art infrastructure, the 44-bedded centre is equipped with advanced technology. The unit has a team of experienced Oncologists from reputed medical institutes and oncology-trained nurses to ensure best of treatment and care.",
    "active": "Y",
    "path": "Jorhat/about/whoWeAre.jpg"
  },
  {
